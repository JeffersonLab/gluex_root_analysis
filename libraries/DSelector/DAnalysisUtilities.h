...
class DAnalysisUtilities
{
	public:
		...
		std::tuple<double,double> Calc_vanHoveCoord(TLorentzVector locBeamP4, Particle_t locTargetPID, TLorentzVector locXP4, TLorentzVector locYP4, TLorentzVector locZP4);
